 ...
 * Brand-scoped admins (brand_admin, franchise_owner, etc.) have their brand_id
 * embedded in the JWT and this store is ignored for them — the interceptor
 * reads brand_id from the JWT claims first, then falls back to this store.
 */
