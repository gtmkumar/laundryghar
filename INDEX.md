...
> AI agents: if you are about to write SQL inside a `.md` file, **stop**. SQL lives only in `database/*.sql`. Markdown may _quote_ SQL for illustration but never _defines_ it.
...
```
92 tables · 5 materialized views · 5 partitioned tables · 258 indexes
7 SQL files · 9 ADRs · 11 agents
