/**
 * Version-gate helpers — rider-mobile.
 *
 ...
 *   The rider app_type has NO rows in the DB yet. When configRows is empty /
 *   missing this module returns { kind: 'none' } silently. Add a row:
 *     INSERT INTO engagement_cms.mobile_app_config
 *       (brand_id, app_type, platform, config_key, config_value)
 *     VALUES
 *       (<brand_uuid>, 'rider', 'ios',     'app_settings', '{"min_version":"1.0.0","force_update_version":"0.9.0"}'),
 *       (<brand_uuid>, 'rider', 'android', 'app_settings', '{"min_version":"1.0.0","force_update_version":"0.9.0"}');
 *
