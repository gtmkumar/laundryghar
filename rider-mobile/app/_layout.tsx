 ...
 *   3. SecureStore (auth) + AsyncStorage (duty) hydration
...
// ---------------------------------------------------------------------------
// OTA update banner (non-blocking, shown until user taps Restart)
// ---------------------------------------------------------------------------
...
// Note: rider app_type has no DB rows yet — gate silently passes until seeded.
// ---------------------------------------------------------------------------
...
function RootLayoutInner() {
  ...
  }, [hydrate, hydrateDuty, hydrateQueue]);
