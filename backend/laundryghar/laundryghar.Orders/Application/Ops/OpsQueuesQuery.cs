...
namespace laundryghar.Orders.Application.Ops;
...
public sealed record OpsQueuesQuery(
    ...
    int PageSize,
    Guid? StoreId
) : IRequest<OpsQueuesResponse>;

public sealed class OpsQueuesHandler : IRequestHandler<OpsQueuesQuery, OpsQueuesResponse>
{
    ...
    public async Task<OpsQueuesResponse> Handle(OpsQueuesQuery q, CancellationToken ct)
    {
