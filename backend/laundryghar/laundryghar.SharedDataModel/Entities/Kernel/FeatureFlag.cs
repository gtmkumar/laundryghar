namespace laundryghar.SharedDataModel.Entities.Kernel;
...
public class FeatureFlag
{
    ...
    public Guid[]? TargetFranchiseIds { get; set; }
    public Guid[]? TargetStoreIds { get; set; }
    public Guid[]? TargetUserIds { get; set; }
    public Guid[]? TargetCustomerIds { get; set; }
