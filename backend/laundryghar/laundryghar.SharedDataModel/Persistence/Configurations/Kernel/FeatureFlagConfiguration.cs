...
public sealed class FeatureFlagConfiguration : IEntityTypeConfiguration<FeatureFlag>
{
    public void Configure(EntityTypeBuilder<FeatureFlag> b)
    {
        ...
        b.Property(e => e.TargetFranchiseIds).HasColumnName("target_franchise_ids").HasColumnType("uuid[]");
        b.Property(e => e.TargetStoreIds).HasColumnName("target_store_ids").HasColumnType("uuid[]");
        b.Property(e => e.TargetUserIds).HasColumnName("target_user_ids").HasColumnType("uuid[]");
        b.Property(e => e.TargetCustomerIds).HasColumnName("target_customer_ids").HasColumnType("uuid[]");
        ...
        b.HasIndex(e => new { e.BrandId, e.FlagKey }).IsUnique().HasDatabaseName("feature_flags_brand_id_flag_key_key");
    }
}
