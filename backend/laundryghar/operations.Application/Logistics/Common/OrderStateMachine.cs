...
///
/// <para>Ported from the legacy Orders bounded context into the Logistics sub-area: the
/// rider pickup-leg completion path walks an order forward along this happy-path.</para>
/// </summary>
