...
/// </summary>
public sealed class PasswordLoginHandler : IRequestHandler<PasswordLoginCommand, TokenResponse>
{
    ...
    public async Task<TokenResponse> Handle(PasswordLoginCommand cmd, CancellationToken ct)
    {
