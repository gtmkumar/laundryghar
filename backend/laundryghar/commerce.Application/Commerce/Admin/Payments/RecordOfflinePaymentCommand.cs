...
/// </summary>
public sealed class RecordOfflinePaymentHandler : ICommandHandler<RecordOfflinePaymentCommand, OfflinePaymentDto>
{
    ...
    public RecordOfflinePaymentHandler(ICommerceDbContext db, ICurrentUser user)
    {
        _db  = db;
        _user = user;
    }

    public async Task<OfflinePaymentDto> HandleAsync(RecordOfflinePaymentCommand cmd, CancellationToken ct)
    {
...
public sealed class RecordOfflinePaymentValidator : AbstractValidator<RecordOfflinePaymentRequest>
{
