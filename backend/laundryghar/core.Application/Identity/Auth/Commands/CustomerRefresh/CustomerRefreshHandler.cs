...
public sealed class CustomerRefreshHandler : ICommandHandler<CustomerRefreshCommand, CustomerTokenResponse>
{
    ...
    public async Task<CustomerTokenResponse> HandleAsync(CustomerRefreshCommand cmd, CancellationToken ct)
    {
