...
///
/// Injects the concrete <see cref="LaundryGharDbContext"/> (allowed in Infrastructure) because
...
public sealed class RefreshTokenRepository : IRefreshTokenRepository
{
    ...
    public RefreshTokenRepository(LaundryGharDbContext db) => _db = db;
    ...
    public async Task InsertRootAsync(RefreshToken token, CancellationToken ct)
    {
        ...
        await _db.Database.ExecuteSqlAsync(
            ...
            INSERT INTO identity_access.refresh_tokens
              (id, user_id, customer_id, token_hash, family_id, parent_token_id,
            ...
            VALUES
              ({token.Id}, {token.UserId}, {token.CustomerId}, {token.TokenHash}, {token.Id}, {token.ParentTokenId},
