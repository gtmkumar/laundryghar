...
/// <summary>UUID-based current-user context for the Catalog service.</summary>
public interface ICurrentUser
{
    ...
    /// - Platform admins: returns X-Brand-Id override (set by TenantResolutionMiddleware) if present; else BrandId.
