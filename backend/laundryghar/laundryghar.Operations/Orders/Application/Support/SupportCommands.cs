...
namespace laundryghar.Orders.Application.Support;
...
public sealed record CreateTicketCommand(
    ...
    Guid? CustomerId, Guid? RiderId, CreateTicketRequest Request) : IRequest<SupportTicketDetailDto>;

public sealed class CreateTicketHandler : IRequestHandler<CreateTicketCommand, SupportTicketDetailDto>
{
    private readonly LaundryGharDbContext _db;
    public CreateTicketHandler(LaundryGharDbContext db) => _db = db;

    public async Task<SupportTicketDetailDto> Handle(CreateTicketCommand cmd, CancellationToken ct)
    {
...
public sealed record GetMyTicketsQuery(Guid BrandId, Guid RequesterId) : IRequest<IReadOnlyList<SupportTicketDto>>;

public sealed class GetMyTicketsHandler : IRequestHandler<GetMyTicketsQuery, IReadOnlyList<SupportTicketDto>>
{
    private readonly LaundryGharDbContext _db;
    public GetMyTicketsHandler(LaundryGharDbContext db) => _db = db;

    public async Task<IReadOnlyList<SupportTicketDto>> Handle(GetMyTicketsQuery q, CancellationToken ct)
...
public sealed class GetTicketDetailHandler : IRequestHandler<GetTicketDetailQuery, SupportTicketDetailDto?>
{
    private readonly LaundryGharDbContext _db;
    public GetTicketDetailHandler(LaundryGharDbContext db) => _db = db;

    public async Task<SupportTicketDetailDto?> Handle(GetTicketDetailQuery q, CancellationToken ct)
    {
...
public sealed class PostTicketMessageHandler : IRequestHandler<PostTicketMessageCommand, TicketMessageDto?>
{
    private readonly LaundryGharDbContext _db;
    public PostTicketMessageHandler(LaundryGharDbContext db) => _db = db;

    public async Task<TicketMessageDto?> Handle(PostTicketMessageCommand cmd, CancellationToken ct)
    {
...
public sealed record GetTicketsInboxQuery(Guid BrandId, string? Status) : IRequest<IReadOnlyList<SupportTicketDto>>;

public sealed class GetTicketsInboxHandler : IRequestHandler<GetTicketsInboxQuery, IReadOnlyList<SupportTicketDto>>
{
    private readonly LaundryGharDbContext _db;
    public GetTicketsInboxHandler(LaundryGharDbContext db) => _db = db;

    public async Task<IReadOnlyList<SupportTicketDto>> Handle(GetTicketsInboxQuery q, CancellationToken ct)
        => await _db.SupportTickets.AsNoTracking()
...
public sealed class UpdateTicketHandler : IRequestHandler<UpdateTicketCommand, SupportTicketDto?>
{
    ...
    private readonly LaundryGharDbContext _db;
    public UpdateTicketHandler(LaundryGharDbContext db) => _db = db;

    public async Task<SupportTicketDto?> Handle(UpdateTicketCommand cmd, CancellationToken ct)
    {
