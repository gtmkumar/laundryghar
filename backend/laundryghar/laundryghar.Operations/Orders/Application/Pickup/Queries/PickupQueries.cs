    ...
    : IRequestHandler<GetPickupRequestsQuery, PaginatedList<PickupRequestDto>>
{
    ...
    public async Task<PaginatedList<PickupRequestDto>> Handle(GetPickupRequestsQuery q, CancellationToken ct)
    {
...
public sealed class GetMyPickupRequestsHandler
    : IRequestHandler<GetMyPickupRequestsQuery, PaginatedList<PickupRequestDto>>
{
    private readonly LaundryGharDbContext _db;

    public GetMyPickupRequestsHandler(LaundryGharDbContext db) => _db = db;

    public async Task<PaginatedList<PickupRequestDto>> Handle(GetMyPickupRequestsQuery q, CancellationToken ct)
    {
...
/// </summary>
public sealed record GetMyPickupRequestByIdQuery(Guid Id, Guid CustomerId) : IRequest<PickupRequestDto?>;

public sealed class GetMyPickupRequestByIdHandler
    : IRequestHandler<GetMyPickupRequestByIdQuery, PickupRequestDto?>
{
    private readonly LaundryGharDbContext _db;

    public GetMyPickupRequestByIdHandler(LaundryGharDbContext db) => _db = db;

    public async Task<PickupRequestDto?> Handle(GetMyPickupRequestByIdQuery q, CancellationToken ct)
    {
