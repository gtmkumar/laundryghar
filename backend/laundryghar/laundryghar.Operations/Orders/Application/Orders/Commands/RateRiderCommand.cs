...
public sealed class RateRiderHandler : IRequestHandler<RateRiderCommand, RateRiderResult>
{
    private static readonly string[] Rateable = ["delivered", "closed"];
    private readonly LaundryGharDbContext _db;
    public RateRiderHandler(LaundryGharDbContext db) => _db = db;

    public async Task<RateRiderResult> Handle(RateRiderCommand cmd, CancellationToken ct)
    {
