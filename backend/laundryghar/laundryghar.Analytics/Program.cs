...
using laundryghar.Analytics.Infrastructure.Auth;
using laundryghar.Analytics.Infrastructure.Services;
using laundryghar.Analytics.Middleware;
...
// ─── Authorization (permission policies; analytics is admin-only) ────────────
...
// ─── API route groups ─────────────────────────────────────────────────────────
// AnalyticsEndpoints self-groups under /api/v1/admin/analytics with RequireAuthorization().
