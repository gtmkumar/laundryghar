...
namespace LaundryGhar.Utilities.CQRS.Behaviors;
...
/// </summary>
/// <remarks>
/// Resolves the ambient <see cref="DbContext"/> from DI. Because <c>laundryghar.Utilities</c> does not
/// reference any concrete context, the application must register its <c>DbContext</c> as the base
/// <see cref="DbContext"/> type (e.g. <c>services.AddScoped&lt;DbContext&gt;(sp =&gt; sp.GetRequiredService&lt;LaundryGharDbContext&gt;())</c>)
