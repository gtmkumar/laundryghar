...
using laundryghar.Warehouse.Application.Common;
...
using laundryghar.Warehouse.Middleware;
...
// ─── Authorization (permission policies; warehouse is admin-only — no CustomerOnly) ─
...
// ─── API route groups ──────────────────────────────────────────────────────
// WarehouseEndpoints self-groups under /api/v1/admin with RequireAuthorization().
